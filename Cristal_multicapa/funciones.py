...
def multicapaDefecto(nperiods, n0, n1, n2, n3, d1, d2, d3, wavel, theta0=0):
    '''
    Calcula los coeficientes de transmisión y reflexión para una multicapa
    ...
    n = [n0] + [n1, n2]*int(nperiods/2) + [n3] + [n1, n2]*int(nperiods/2)+ [n0]
    d = [0] + [d1, d2]*int(nperiods/2) + [d3] + [d1, d2]*int(nperiods/2) + [0]
